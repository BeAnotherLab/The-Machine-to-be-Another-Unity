...
/// </summary>
public class CustomCallApp : MonoBehaviour
{

    public static CustomCallApp instance;
    ...
    protected virtual void OnCallFactoryReady()
    {
        ...
        CustomCallAppUi.instance.SetGuiState(true);
    ...
    public virtual void SetupCall()
    {
        ...
        CustomCallAppUi.instance.SetGuiState(false);
    }
            ...
            case CallEventType.Message:
                {
                    ...
                    CustomCallAppUi.instance.videoMeshRenderer.transform.localRotation = new Quaternion(
    ...
    protected virtual void UpdateFrame(FrameUpdateEventArgs frameUpdateEventArgs)
    {
        ...
        {
            CustomCallAppUi.instance.UpdateLocalTexture(frameUpdateEventArgs.Frame, frameUpdateEventArgs.Format);
        }
        else
        {
            CustomCallAppUi.instance.UpdateRemoteTexture(frameUpdateEventArgs.Frame, frameUpdateEventArgs.Format);
        }
    }
    ...
    {
        CustomCallAppUi.instance.Append(txt);
    }
}
