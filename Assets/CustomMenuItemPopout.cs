...
// This is a custom version of a class that 'pops' a menu item out
// when the user looks at them.
public class CustomMenuItemPopout : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        m_PoppedPosition = m_Transform.position + m_Transform.up * m_PopDistance;
    }
