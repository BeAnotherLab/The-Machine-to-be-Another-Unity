...
namespace VRStandardAssets.Menu
{
	...
	public class MenuButtonBAL : MonoBehaviour
	{
		public event Action<MenuButtonBAL> OnButtonSelected;                   // This event is triggered when the selection of the button has finished.
