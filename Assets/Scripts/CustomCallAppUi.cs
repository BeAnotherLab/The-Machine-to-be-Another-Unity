...
/// </summary>
public class CustomCallAppUi : MonoBehaviour
{
    public static CustomCallAppUi instance;
    
    /// <summary>
    /// Texture of the local video    z
    /// </summary>
    ...
    {
        CustomCallApp.instance.SetVideoDevice(GetSelectedVideoDevice());
        CustomCallApp.instance.SetAudio(uAudioToggle.isOn);
        CustomCallApp.instance.SetVideo(uVideoToggle.isOn);
        ...
        CustomCallApp.instance.SetIdealResolution(width, height);
        CustomCallApp.instance.SetIdealFps(fps);
        CustomCallApp.instance.SetAutoRejoin(uRejoinToggle.isOn);
        CustomCallApp.instance.SetShowLocalVideo(uLocalVideoToggle.isOn);
        CustomCallApp.instance.SetupCall();
        EnsureLength();
        Append("Trying to listen on address " + uRoomNameInputField.text);
        CustomCallApp.instance.Join(uRoomNameInputField.text);
    }
    ...
    public void UpdateVideoDropdown()
    {
        ...
        uVideoDropdown.AddOptions(new List<string>(CustomCallApp.instance.GetVideoDevices()));
        uVideoDropdown.interactable = CustomCallApp.instance.CanSelectVideoDevice();
    ...
    private void SendMsg(string msg)
    {
        ...
        Append(msg);
        CustomCallApp.instance.Send(msg);
    ...
    {
        CustomCallApp.instance.ResetCall();
    }

    public void OnVolumeChanged(float value)
    {
        CustomCallApp.instance.SetRemoteVolume(value);
    }
    ...
    {
        bool state = CustomCallApp.instance.IsMute();
