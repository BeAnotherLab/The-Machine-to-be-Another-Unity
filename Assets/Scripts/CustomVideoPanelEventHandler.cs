...
/// </summary>
public class CustomVideoPanelEventHandler : MonoBehaviour, IPointerClickHandler
{
    private CustomCallAppUI mParent;
    private float mLastClick;

    private void Start()
    {
        mParent = this.GetComponentInParent<CustomCallAppUI>();
        if(mParent == null)
        {
